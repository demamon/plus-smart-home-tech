...
public class ErrorResponseOrder {
    ...
    public ErrorResponse handleNonAuthorizedUserException(NonAuthorizedUserException e) {
    ...
    public ErrorResponse handleOrderNotFoundException(NoOrderFoundException e) {
